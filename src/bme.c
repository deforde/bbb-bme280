...
static bool
read_val_20u(int                  i2c_dev,
             const uint8_t *const addrs,
             size_t               n_addrs,
             int32_t *            val)
{
    assert(n_addrs == 3);
...
static bool
read_val_8u(int i2c_dev, uint8_t addr, int32_t *val)
{
    uint8_t reg_val = 0;
...
static bool
read_val_8s(int i2c_dev, uint8_t addr, int32_t *val)
{
...
bool
bme_get_temp(int i2c_dev, float *t_degC, int32_t *t_fine)
{
    int32_t       adc_T         = 0;
    const uint8_t adc_T_addrs[] = { 0xFA, 0xFB, 0xFC };
    if (!read_val_20u(i2c_dev,
                      adc_T_addrs,
...
bool
bme_get_pressure(int i2c_dev, int32_t t_fine, float *p_kPa)
{
    int32_t       adc_P         = 0;
...
bool
bme_get_humidity(int i2c_dev, int32_t t_fine, float *humidity_pcnt)
{
    int32_t       adc_H         = 0;
